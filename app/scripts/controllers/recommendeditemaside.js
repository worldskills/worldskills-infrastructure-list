...
angular.module('ilApp')
  .controller('recommendedItemAsideCtrl', function ($scope, $uibModalInstance, Items, WSAlert, MULTIPLIERS, MULTIPLIER_DEFAULT, ITEM_STATUS_TEXT, API_IL, RecommendedItems, $translate, auth) {
